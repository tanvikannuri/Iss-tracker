...
export default class MeteorScreen extends Component {
    ...
    getMeteors = () => {
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=gLI4t3Nop7K4TK5L2APiRPRNtz3DrQeEElKzWoo5")
            .then(response => {
            ...
            <View>
                <ImageBackground source = {bg_img}  style ={styles.backgroundImage}>
                    <View style={styles.gifContainer}>
                        <Image soure={speed} style={{width:size,height:size,alignSelf:"center"}}>
                            <Text 
